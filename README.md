...
Experiment 4: To explore Text Generation using Recurrent Neural Networks (RNNs) and understand the impact of different word representations:
     1.One-Hot Encoding
...
Experiment 5: The goal of this assignment is to implement a sequence to sequence (seq2seq) model for machine translation from English to Spanish. You will explore 
two architectures:
